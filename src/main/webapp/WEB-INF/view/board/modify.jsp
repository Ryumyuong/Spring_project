	...
	<div class="content">
		<form role="form" action="/board/modify?bno=${board.bno }" method="post" name="update">
			...
			<div id="modifyTitle" class="modifyArea">
				<h2>기업명</h2>
				<div>
					<input type="text" id="company" name="company" maxlength="25" value="${board.company }" style="border: 1px solid;">
				</div>
			</div>
			...
			<div id="modifyIntroduct" class="modifyArea">
				...
				<div class="resizable-textarea">
					<span>
						<textarea id="satis" name="satis" cols="30" rows="10" class="board_satis" style="border: 1px solid;">${board.satis }</textarea>
					</span>
				</div>
			</div>
			<p class="complete">
